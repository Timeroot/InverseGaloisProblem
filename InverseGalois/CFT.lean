...
* `InverseGalois.CFT.Brauer.SolvableBound` propagates a bound `|Br(E / F)| ≤ [E : F]` from cyclic
  ...
  The class of fields carrying the cyclic bound is imposed on the larger field of the extension and
  is asked only to be inherited by fixed subfields, which is what the dévissage produces.
