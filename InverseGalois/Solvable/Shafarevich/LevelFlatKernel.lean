...
one of them lies inside a member of it.  They are also asked to be pairwise non-conjugate, so that
the prescriptions made at two different ones are made at two genuinely different places.
